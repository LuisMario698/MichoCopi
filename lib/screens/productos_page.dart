...
class _ProductosPageState extends State<ProductosPage> {
  ...
  Future<void> _cargarDatos() async {
    ...
    try {
      ...
      final categoriasResult = futures[1];      if (productosResult['success']) {
        ...
        for (final producto in productos) {
          if (producto.id != null) {
            final materias =
                await ProductoService.obtenerMateriasPrimasDeReceta(
                  producto.idReceta,
                );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Error al cargar productos: ${productosResult['message']}'),
      ...
      if (categoriasResult['success']) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Error al cargar categorías: ${categoriasResult['message']}'),
              backgroundColor: Colors.red,
            ),
          );
        }
    ...
    try {
      ...
      if (result['success']) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Error al eliminar el producto: ${result['message']}',
            ),
            backgroundColor: Colors.red,
          ),
        );
                    ...
                    _isLoading
                        ...
                        : GridView.builder(
                          ...
                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                            ...
                            mainAxisSpacing: 16,
                            childAspectRatio:
                                0.75, // Reducido de 0.85 para dar más espacio vertical
                          ),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap:
                                  () => _mostrarMenuProducto(context, producto),
                              onLongPress:
                                  () => _mostrarMenuProducto(context, producto),
                              child: Card(
                                elevation: 3,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (_materiasPrimasPorProducto[producto
                                                        .id] !=
                                                    null &&
                                                _materiasPrimasPorProducto[producto
                                                        .id]!
                                                    .isNotEmpty)
                                              Flexible(
                                                child: Container(
